...
export class PreviewGenerator {
     ...
     * 创建一个预览卡片 DOM 元素
     */
    async createPreviewItem(layouts: LayoutBlock[], index: number, totalCount: number, templateId: string, config: TemplateConfig, onDownload: (index: number) => void): Promise<HTMLDivElement> {
